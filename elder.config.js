...
module.exports = {
  origin: 'https://paratonsp.my.id', // TODO: update this. The URL of your site's root, without a trailing slash
  lang: 'en',
  srcDir: 'src',
  distDir: 'public',
  rootDir: process.cwd(),
  ...
  plugins: {
    ...
    '@elderjs/plugin-sitemap': {
      origin: 'https://paratonsp.my.id', // the https://yourdomain.com
